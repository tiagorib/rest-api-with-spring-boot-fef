...
public class ProductController {
    ...
    @Operation(summary = "Method for insert products")
    ...
    @Operation(summary = "Method for delete product")
    ...
    @Operation(summary = "Method for find product by productid")
    ...
    @Operation(summary = "Method for update products")
