...
public class CustomerController {
    ...
    @Operation(summary = "Method for insert customers in database")
    ...
    @Operation(summary = "Method for delete customers from database")
    ...
    @Operation(summary = "Method for find customers by idCustomer in database")
